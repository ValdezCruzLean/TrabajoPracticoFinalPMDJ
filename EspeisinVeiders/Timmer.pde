...
// private PImage imagen;
 //-----------Zona de constructores-----------
  ...
  public Timmer() {
    ...
    this.posicion = new PVector(640, 175); //Asigna una posicion por defecto
...
/**
   ...
   */
  public Timmer(PVector posicion, float time) {
...
//------------Zona de Metodos-----------    
 ...
 //   imagen.resize(120, 120);// Redimensionar la imagen a 120x120 píxeles
  //  image(imagen, this.posicion.x+20, this.posicion.y-10 );//Muestra la imagen del Lapiz en su posición en x +20 y en Y -10
    ...
    textSize(20);//Asigna el tamaño del texto
    text("Time < " + (int) this.time+" >", this.posicion.x, this.posicion.y);//Muestra el texto como entero
  }
